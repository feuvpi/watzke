...
const Navbar = () => {
  return (
    <>
      <nav className='block sticky top-0 z-100 h-10 bg-indigo-700 border-b border-indigo-500'>
        <div className='items-center flex w-auto justify-between justify-self-center h-10 max-w-2xl m-auto px-4'>
